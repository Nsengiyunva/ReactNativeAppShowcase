...
import { View, StatusBar, ScrollView, Image, TouchableOpacity, Text, Dimensions } from 'react-native';
...
class Accounts extends Component {
	...
	topHeaderComponent = (
		<View style={{ width: '100%', height: '100%', justifyContent: 'center', alignItems: 'flex-end' }}>
			...
			>
				<Image source={Profile} style={{ width: '98%', height: '98%', borderRadius: 50 }} resizeMode="cover" />
			</View>
		</View>
	);

	bottomHeaderComponent = (
		<View style={{ width: '100%', height: '100%', alignItems: 'flex-end', display: 'flex', flexDirection: 'row' }}>
			<View style={{ width: '80%', height: '100%', left: 0, justifyContent: 'center', marginLeft: '5%' }}>
				<Text allowFontScaling style={{ fontSize: 20, fontWeight: 'bold', color: 'rgba(255,255,255,.7)' }}>
					Pamoja Accounts
				</Text>
			</View>
			<View
			...
			>
				<TouchableOpacity onPress={() => alert(Dimensions.get('screen').width)}>
					<Icon name="md-add" size={this.width > 320 ? 25 : 15} color="white" style={{ padding: 5 }} />
				</TouchableOpacity>
			</View>
		</View>
	);
	...
	navigateToAccountDetails = () => this.props.navigation.navigate('AccountDetails');
